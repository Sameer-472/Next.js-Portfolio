...
export default function FeatureProjects() {
  ...
  const nextProjects = [
    ...
    },
    {
      ...
      details:
        "Build the Next auth toolkit using the newest Next Auth v5 (Auth.js).Worked on Two Factor Authentication (2FA), Forgot Password functionality, Email Verification functionality, Credential Login, OAuth (Google & Github) Login and much more.",
      overview:
        "Build the Next auth toolkit using the newest Next Auth v5 (Auth.js).Worked on Two Factor Authentication (2FA), Forgot Password functionality, Email Verification functionality, Credential Login, OAuth (Google & Github) Login and much more",
