...
// import profilePic from "@/public/other/profile.jpg";
            ...
            >
                ...
                >
                    <div className="bento-grid-container h-[120px] flex items-center justify-center">
                        <h1 className="text-[150%] lg:text-[200%] font-black leading-none group-hover:scale-105 transition-all ease-in-out duration-500 text-[#A855F7]">
                            Hire <br /> me.
                        </h1>
                    </div>
                </motion.div>
